...
#ifndef particledb_interaction_filter_Section_h
#define particledb_interaction_filter_Section_h
...
namespace particledb {
  namespace interaction {
    namespace filter {
      ...
      }/* namespace particledb::interaction::filter::detail */
...
#endif // particledb_interaction_filter_Section_h
